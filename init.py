...
author = "CJ Sveningsson"               # Name automatically put in the code templates.
...
last_advent_of_code_year = 2015     # The setup will download all advent of code data up until that date included
